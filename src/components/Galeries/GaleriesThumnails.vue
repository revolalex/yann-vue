...
.galeriesBox:hover::after {
  background-color: #000;
  opacity: 0.4;
}

.galeriesContainer .galeriesBox .caption {
  position: absolute;
  z-index: 60;
  width: 90%;
  margin-left: 5%;
